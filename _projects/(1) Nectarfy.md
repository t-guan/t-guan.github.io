...
{% include elements/figure.html image="/assets/images/nectarfy/HexahiveTeam.png" caption="Hexahive Team" %}
...
{% include elements/button.html link="https://bigideascontest.org/projects/hexahive/" text="Big Ideas Grand Finalist" style="outline-dark" size="lg" %}
